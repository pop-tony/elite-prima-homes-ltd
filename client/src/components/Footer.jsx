...
export default function Footer(){
  ...
  const socials = [
    { icon: FaFacebook, href: 'https://facebook.com/eliteprimahomes', label: 'Facebook' },
    { icon: FaInstagram, href: 'https://instagram.com/eliteprimahomes', label: 'Instagram' },
    { icon: FaTwitter, href: 'https://x.com/eliteprimahomes', label: 'X' },
    { icon: FaLinkedin, href: 'https://linkedin.com/company/eliteprimahomes', label: 'LinkedIn' },
    { icon: FaYoutube, href: 'https://youtube.com/@eliteprimahomes', label: 'YouTube' },
  ...
  const links = {
    ...
    company: [
      {name:'About Elite PriMa', path:'/about'},
      ...
      <div className="mx-auto max-w-7xl px-4 md:px-8 pt-12 md:pt-16 pb-8">
          ...
          <div>
            <div className="flex items-center gap-3">
              ...
              <div className="leading-[0.9]">
                <p className={`font-black text-base tracking-wide transition-colors ${isDark?'text-white':'text-[#0A2342]'}`}>ELITE PRIMA</p>
                <p className={`text- font-bold tracking-[0.22em] uppercase transition-colors ${isDark?'text-white/60':'text-black/40'}`}>Homes Ltd</p>
              </div>
            </div>
        ...
        <div className={`mt-12 flex flex-col md:flex-row items-center justify-between gap-6 border-t pt-8 transition-colors ${isDark?'border-white/10':'border-black/5'}`}>
          <div className="flex flex-wrap items-center gap-4">
            <p className={`text- transition-colors ${isDark?'text-white/30':'text-black/30'}`}>© {year} Elite PriMa Homes Ltd • Lakeside Estate • GREDA Licensed</p>
          </div>

          <div className="flex items-center gap-6">
            <div className="flex items-center gap-3">
              <a href="mailto:hello@eliteprimahomes.com" className={`h-9 w-9 rounded-xl flex items-center justify-center border transition-colors ${isDark?'bg-white/5 border-white/10 text-white/60 hover:bg-white hover:text-[#0A2342]':'bg-white border-black/5 text-black/40 hover:bg-[#0A2342] hover:text-white'}`}><Mail className="h-4 w-4"/></a>
